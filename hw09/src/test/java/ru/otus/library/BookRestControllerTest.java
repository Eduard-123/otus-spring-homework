...
import ru.otus.library.controller.BookRestController;
...
public class BookRestControllerTest {
    ...
    @DisplayName("должен выдавать список книг при GET запросе без параметров")
    @Test
    ...
    @DisplayName("должен выдавать статус 201 CREATED при успешном сохранении книги")
    @Test
